...
if (strpos($this_site,'60') !== false) {
   ...
   $good='Yes';
   $bad='No';
} elseif (strpos($this_site, '200') !== false) {
   $this_site_number='200';
   $above_or_below='above';
   $good='Yes';
   $bad='No';
} elseif (strpos($this_site, '300') !== false) {
   $this_site_number='300';
   $above_or_below='above';
   $good='Yes';
   $bad='No';
   ...
   $good='Yes';
   $bad='No';
} elseif (strpos($this_site, '500') !== false) {
   $this_site_number='500';
   $above_or_below='above';
   $good='Yes';
   $bad='No';
} else {
